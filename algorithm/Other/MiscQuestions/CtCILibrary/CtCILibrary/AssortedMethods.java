...
public class AssortedMethods {
	...
	/**
	 * Generate a random integer, 0 <= return value < n (exclusive)
	 * @param n
	 * @return random int
	 */
	...
	/**
	 * Generate a random integer, min <= return value <= max (both inclusive)
	 * @param min
	 * @param max
	 * @return random int
	 */
	...
	/**
	 * Generate a matrix with size M*N, elements range from min to max, inclusive.
	 * @param M
	 * @param N
	 * @param min
	 * @param max
	...
	/**
	 * Generate an array with size N, elements range from min to max, inclusive.
	 * @param N
	 * @param min
	 * @param max
	 * @return
	...
	/**
	 * Create a doubly linked list with length N, elements range from min to max, inclusive.
	 * @param N
	 * @param min
	 * @param max
	...
	/**
	 * Return a list of words, approximately 2000 words.
