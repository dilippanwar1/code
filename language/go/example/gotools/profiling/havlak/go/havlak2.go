...
//   $ time ./havlak1
//
// Run and output profile:
//   $ ./havlak1 -cpuprofile=havlak1.prof
//
// Entering pprof:
//   $ go tool pprof havlak1 havlak1.prof
//
// There are quite a few commands in pprof to help find bottleneck. In this
// case, we use 'web', 'list', 'top5'. In short, use 'top5' to find what's
// using most of the cpu time; then use 'web' to find who's calling the
// function; then 'list' to find out the lines. Based on the information,
// we change `number` variable in DFS from map to slice.
//
package main
