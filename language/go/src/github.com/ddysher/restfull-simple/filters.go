...
// When applied to the restful.DefaultContainer, we refer to them as a global filter - they are processed
//   before any registered WebServices.
// When applied to WebService, they are processed before any Route of WebService.
// When applied to Route, the are processed before calling the function associated with the Route.
//
