...
import (
	...
	"github.com/ddysher/context/google"
	"github.com/ddysher/context/userip"
...
func handleSearch(w http.ResponseWriter, req *http.Request) {
	...
	if err == nil {
		...
		// parent.Done is closed, cancel is called, or timeout elapses.
		ctx, cancel = context.WithTimeout(context.Background(), timeout)
	} else {
		// WithCancel returns a copy of parent whose Done channel is closed as soon as
		// parent.Done is closed or cancel is called. context.Background() is the an
