 ...
 *
 * Investigate using filter programs with pcap_compile() and pcap_setfilter()
 *
 **********************************************************************/

/*
  Compile
   $ gcc testpcat3.c -lpcap
  Run
   $ sudo ./a.out "host www.taobao.com"
  Test
   $ curl www.baidu.com
   $ curl www.taobao.com
*/
...
int main(int argc, char **argv)
{
  ...
  /* i.e. compile 'argv[1]' to filter program 'fp' */
