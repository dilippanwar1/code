...
//
// Certificate: Certificate file usually has extension .crt, .cer or .cert.
//   It's fully qualified name is "Public Key Certificate".
...
//
// PublicKey/PrivateKey: As mentioned above, certificate contains information
//   about public key. Private key file ususally has extension .key. A private
//   key is an encryption/decryption key known only to the party or parties that
//   exchange secret messages
//
// PEM: PEM is Governed by RFCs, it's used preferentially by open-source software.
...
//   root certificates.
//
// PKI: A public key infrastructure (PKI) supports the distribution and
...
//
// X.509: X.509 is a widely used standard for a public key infrastructure (PKI)
