/*
 * This module creates target for linear device mapper which maps a linear
 * range of the device-mapper device onto a linear range of another device.
 *
 * See:
 ...
 *
 * Only tested on linux kernel 2.6.32.
 */
 ...
 * of type 'hello_target'. i.e on execution of command 'dmsetup create'. It gets
 * called per device.
 */
...
/*
 * This is destruction function, gets called per device. It removes device
 * and decrement device count.
 */
